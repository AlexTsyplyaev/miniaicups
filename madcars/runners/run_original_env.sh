...
echo "options: $runs $train ${@:2}"
echo "------------------------------------"
echo "Game:"

python3 -u $runner_folder/localrunner.py -f "python3 -u $agent_folder/pytorch_main.py $train" -s "python3 -u $agent_folder/pytorch_main.py $train" ${runs} ${@:2}
